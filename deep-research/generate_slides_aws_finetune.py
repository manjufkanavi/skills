#!/usr/bin/env python3
"""Generate HTML slideshow from technical guide for AWS fine-tuning research."""
import json
import re
...
guide_path = Path("/Users/manjunathkanavi/.nanobot/workspace/personal_bot/skills/deep-research/reports/fine-tune-7b-local-llm-aws-services-api-costs-mcp-vs-fine-tuning-rag-hybrid-strategy-data-collection/2026-07-14/technical-guide.md")
...
slides = []
slides.append({
    "title": "Fine-Tuning 7B LLM with AWS Knowledge",
    "subtitle": "MCP vs Fine-Tuning vs RAG — Hybrid Strategy",
...
section_map = {
    ...
    "Part 1: AWS Knowledge Base": "AWS Service Inventory",
    "Part 2: Data Collection Strategy": "Data Collection",
    "Part 3: Fine-Tuning Strategy": "Fine-Tuning Approaches",
    "Part 4: MCP vs Fine-Tuning vs RAG": "Approach Comparison",
    "Part 5: Hybrid Strategy": "Hybrid Architecture",
    "Part 6: Cost Analysis": "Cost Breakdown",
    "Part 7: Recommended Tools": "Tools & Software",
    "Part 8: Complete Setup Script": "Setup Automation",
...
slides.append({
    ...
    "bullets": [
        "Use QLoRA fine-tuning for stable AWS knowledge (cost: under $1)",
        "Implement RAG for dynamic data (pricing, service limits)",
        "Add MCP tools for AWS SDK integration and action execution",
        "Deploy on single GPU: RTX 4090 or Mac Studio M4",
        "Expected accuracy: 85-95% on AWS knowledge queries",
        "Response time: sub-100ms for knowledge queries"
    ],
    "type": "content"
})
...
<title>AWS Fine-Tuning Research</title>
<style>
...
slide_path = report_dir / f"fine-tune-7b-local-llm-aws-services-api-costs-mcp-vs-fine-tuning-rag-hybrid-strategy-data-collection-{timestamp}.html"
