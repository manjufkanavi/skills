#!/usr/bin/env python3
"""Generate HTML slideshow from technical guide for ComfyUI + Flux 2 + MLX."""
import json
import re
...
guide_path = Path("/Users/manjunathkanavi/.nanobot/workspace/personal_bot/skills/deep-research/reports/comfyui-cli-hermes-agent-flux-2-mlx-mac-studio-m4-image-generation/2026-07-13/technical-guide.md")
...
slides = []
slides.append({
    "title": "ComfyUI CLI + Flux 2 + MLX on Mac Studio M4",
    "subtitle": "Complete Technical Guide",
    "body": "Step-by-step setup for image generation with Hermes Agent",
    "type": "title"
})
...
section_map = {
    ...
    "Step 1: Install MLX for Apple Silicon": "MLX Installation",
    "Step 2: Install ComfyUI CLI": "ComfyUI Setup",
    "Step 3: Download Flux 2 Models": "Flux 2 Models",
    "Step 4: Configure ComfyUI for MLX": "MLX Configuration",
    "Step 5: Set Up Hermes Agent": "Hermes Agent Setup",
    "Step 6: Create ComfyUI CLI Skill": "Skill Development",
    "Step 7: Create Flux 2 MLX Generator": "MLX Generator",
    "Step 8: Integrate with Hermes Agent": "Agent Integration",
    "Step 9: Performance Optimization": "Performance Tuning",
    "Step 10: Complete Setup Script": "Setup Automation",
...
slides.append({
    "title": "Key Takeaways",
    "bullets": [
        "MLX provides native Apple Silicon optimization for Flux 2 models",
        "ComfyUI CLI enables workflow-based image generation",
        "Hermes Agent provides agent-based control and automation",
        "Mac Studio M4 with 64GB RAM supports Flux 2 Dev at 4-bit quantization",
        "Complete setup takes ~15 minutes with automated scripts",
        "Production-ready with API integration and batch processing"
    ],
    "type": "content"
})
...
<title>ComfyUI CLI + Flux 2 + MLX Guide</title>
<style>
...
slide_path = report_dir / f"comfyui-cli-hermes-agent-flux-2-mlx-mac-studio-m4-image-generation-{timestamp}.html"
