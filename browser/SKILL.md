...
```bash
bash skills/browser/scripts/launch.sh
```
...
```bash
bash skills/browser/scripts/status.sh
```

### Stop the Browser

```bash
bash skills/browser/scripts/stop.sh
```
...
- The browser must be launched before use: `bash skills/browser/scripts/launch.sh`
